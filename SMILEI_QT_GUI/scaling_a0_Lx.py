...
Lx_max_model_list_12_V2 = []

Lx_max_model_list_16 = []
Lx_max_model_list_9 = []

for a0 in a0_range_smooth:
    Lx_max_model_6 = np.max(LxEpolar(R,THETA,x0,w0,a0,3/8*6*l0))
    Lx_max_model_list_6.append(Lx_max_model_6)
    Lx_max_model_12 = np.max(LxEpolar(R,THETA,x0,w0,a0,3/8*12*l0))
    Lx_max_model_list_12.append(Lx_max_model_12)
    
    Lx_max_model_list_12_V2.append(np.max(LxEpolar_V2_O3(R,THETA,x0,w0,a0,3/8*12*l0)))
    
    Lx_max_model_9 = np.max(LxEpolar(R,THETA,x0,w0,a0,3/8*9*l0))
    Lx_max_model_list_9.append(Lx_max_model_9)
    Lx_max_model_16 = np.max(LxEpolar(R,THETA,x0,w0,a0,3/8*16*l0))
...
Lx_max_model_list_12_V2 = np.array(Lx_max_model_list_12_V2)
...
plt.plot(a0_range_smooth,Lx_max_model_list_12 * np.sqrt(1 + (k*a0r)**2 + 1/4*(k*a0r)**4),
         "-", color="r",label="Model*$\sqrt{1+(0.6*a_0)^2 + 1/4(0.6*a0)^4}$", lw=2)
plt.plot(a0_range_smooth,Lx_max_model_list_12_V2 * np.sqrt(1 + (k*a0r)**2 + 1/4*(k*a0r)**4),
         "-", color="C2",label="EzO3 Model*$\sqrt{1+(0.6*a_0)^2 + 1/4(0.6*a0)^4}$", lw=2)
